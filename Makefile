all: docs/ar6-wg-i.html docs/ar6-wg-ii.html docs/ar6-wg-iii.html docs/ar5-wg-i.html docs/ar5-wg-iii.html docs/ar4-wg-i.html docs/tar-wg-i.html docs/sar-wg-i.html docs/far-wg-i.html docs/far-wg-iii.html docs/sr15.html docs/sres-wg-iii.html docs/supprep1992-wg-i.html
...
docs/far-wg-iii.html: far-wg-iii.bib
	cd docs; bibtex2html -single -css bulma.min.css -header "<section class='section'><div class='container'><h1 class='title'>FAR WG III</h1><p><a href='index.html'>Back to overview</a></p>" -footer "</div></section>" ../$<
	sed -i s/'<!DOCTYPE HTML PUBLIC "-\/\/W3C\/\/DTD HTML 4.01 Transitional\/\/EN">'/'<!DOCTYPE html>'/ docs/far-wg-iii.html
	sed -i s/'<head>'/'<head><meta charset="utf-8">'/ docs/far-wg-iii.html
...
docs/sres-wg-iii.html: sres-wg-iii.bib
	cd docs; bibtex2html -single -css bulma.min.css -header "<section class='section'><div class='container'><h1 class='title'>Special Report Emission Scenarios</h1><p><a href='index.html'>Back to overview</a></p>" -footer "</div></section>" ../$<
